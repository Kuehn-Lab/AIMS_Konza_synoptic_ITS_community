...
So, kicking off presentation figures with an ASV accumulatio curve, fungi only
...
```{r}
setwd('/Users/chunk/AIMS_Konza_synoptic_ITS_community/analysis')
...
#taxtab <- as.matrix(read.csv("full_euk_ensembleTax_tab_kzsyn_04112023.csv", header = T, row.names=1))
taxtab <- as.matrix(read.csv("FUNGITAX_ensembleTax_tab_kzsyn_04112023.csv", header = T, row.names=1))

#taxtab <- as.matrix(read.csv("fun_algal_taxonomy.csv", header = T, row.names=1))
#traits <- as.matrix(read.csv("trait_tab.csv", header = T, row.names=1))
#taxtab <- cbind(taxtab,traits)

#metadata_full <- read.csv("practice_metadata.csv", row.names=1)
...
### remove samples with less than 1000 reads, that's our psychological minimum read depth, so we can better evaluate read depth across our viable samples...
cured_asvs <- cured_asvs[rowSums(cured_asvs)>1264,]
#remove ASVs with zero reads left, we'll do this again aftern rarefying...
cured_asvs <- cured_asvs[,colSums(cured_asvs)>0]
summary(rowSums(cured_asvs))
#rowSums(cured_asvs)
...
png(paste("ASVaccumsub.png"), width = 500, height = 300)
...
```{r}
stressplot(braymds3)
factorfit(brayscores3, samdftest$substrate, permutations = 999)
factorfit(brayscores3, samdftest$WetDry, permutations = 999)
factorfit(brayscores3, samdftest$WetDry, strata = samdftest$substrate, permutations = 999)
...
```{r}
nmdsp3 <- plot_ordination(pseqtest, braymds3, type="samples", color="substrate", shape="Watershed")+
  geom_point(size=2)
nmdsp3
...
```
### split Ascomycota and Basidiomycota
```{r}
...
```{r}
write.csv(major_taxa_counts_tab, "majortaxa_count_rar_43023.csv")
...
write.csv(major_taxa_proportions_tab, "majortaxa_relative abundance_rar.csv")
...
write.csv(tax_merge, "1216R_05272023_taxmerge.csv")
...
```{r}
#MANOVA
manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Kickxellomycota,p__Rozellomycota,p__Blastocladiomycota,p__Aphelidiomycota, c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,c__Lecanoromycetes,f__Verrucariaceae,f__Phaeosphaeriaceae, f__Trichomeriaceae, f__Pleosporaceae) ~ WetDry*substrate, data=taxmerge)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

#MANOVA
manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Kickxellomycota,p__Rozellomycota,p__Blastocladiomycota,p__Aphelidiomycota, c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,c__Lecanoromycetes,f__Verrucariaceae,f__Phaeosphaeriaceae, f__Trichomeriaceae, f__Pleosporaceae) ~ Discharge..L.s.*substrate, data=taxmerge)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

#MANOVA
manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Kickxellomycota,p__Rozellomycota,p__Blastocladiomycota,p__Aphelidiomycota, c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,c__Lecanoromycetes,f__Verrucariaceae,f__Phaeosphaeriaceae, f__Trichomeriaceae, f__Pleosporaceae) ~ stic_wet_prob*substrate, data=taxmerge)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

#MANOVA
manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Kickxellomycota,p__Rozellomycota,p__Blastocladiomycota,p__Aphelidiomycota, c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,c__Lecanoromycetes,f__Verrucariaceae,f__Phaeosphaeriaceae) ~ Rip_type*substrate, data=taxmerge)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)


manphy2 <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Kickxellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,c__Lecanoromycetes
                       # , p__Ochrophyta
                        ) ~ lnContribWSha*substrate, data=taxmerge)
hist(manphy2$residuals)
plot(manphy2$residuals ~ manphy2$fitted.values)
summary.aov(manphy2)

###FAMILIES!!!
manphy6 <- manova(cbind(p__Basidiomycota,c__Lecanoromycetes,f__Verrucariaceae,f__Mortierellaceae) ~ WetDry*substrate, data=taxmerge)
hist(manphy6$residuals)
plot(manphy6$residuals ~ manphy6$fitted.values)
summary.aov(manphy6)
...
library("ggpattern") 
myColors <- c("#00BFC4", "#F8766D","#7CAE00")
names(myColors) <- levels(taxmerge$substrate)
custom_colors <- scale_colour_manual(name = taxmerge$substrate, values = myColors)
df <- data.frame(level = levels(taxmerge$substrate), outcome = c("#00BFC4", "#F8766D","#7CAE00"))

rozello_wetdry <- ggplot(taxmerge, aes(x=WetDry, y=log(p__Rozellomycota), fill=WetDry)) +
  facet_grid(. ~ substrate, labeller = sub_labeller)+
  scale_x_discrete(labels=c('WET'='Wet', 'DRY'='Dry'))+
  geom_boxplot() +
 # geom_boxplot_pattern(aes(pattern = WetDry), outlier.shape = NA, show.legend = FALSE) +
 ...
 # scale_fill_grey(start=0.9, end=0.35) +
  ...
  geom_signif(comparisons = list(c("WET", "DRY")), y_position = 5,
              map_signif_level=TRUE)+
  labs(title = "Relative abundance of Dothidiomycetes in Leaf Litter")+
 # scale_fill_discrete(labels=c('B'='Epilithic biofilms', 'L'='Leaf litter', 'S'='Benthic sediment'))+
  #aes(fill=alpha$substrate, show.legend=FALSE)+
  theme(legend.position='none',axis.text.x = element_text(size=14), axis.title.x = element_blank(),strip.text.x = element_text(size = 11))
#  geom_boxplot(aes(fill=alpha$substrate)) +
...
rozello_wetdry2 <- ggplot(taxmerge, aes(x=stic_wet_prob, y=p__Rozellomycota, color=WetDry)) +
  facet_grid(. ~ substrate, labeller = sub_labeller)+
  #scale_x_discrete(labels=c('WET'='Wet', 'DRY'='Dry'))+
  geom_point() +
  #geom_boxplot_pattern(aes(pattern = WetDry), outlier.shape = NA, show.legend = FALSE) +
 ...
 # scale_fill_grey(start=0.9, end=0.35) +
  ...
  #geom_signif(comparisons = list(c("WET", "DRY")), y_position = 5,
  #            map_signif_level=TRUE)+
  labs(title = "Rozellomycota relative abundance in epilithon")+
 # scale_fill_discrete(labels=c('B'='Epilithic biofilms', 'L'='Leaf litter', 'S'='Benthic sediment'))+
  #aes(fill=alpha$substrate, show.legend=FALSE)+
  theme(legend.position='none',axis.text.x = element_text(size=14), axis.title.x = element_blank(),strip.text.x = element_text(size = 11))
#  geom_boxplot(aes(fill=alpha$substrate)) +
...
#MANOVA
manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae) ~ WetDry, data=taxmerge_L)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae, f__Helotiales_fam_Incertae_sedis) ~ WetDry, data=taxmerge_L)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae, f__Helotiales_fam_Incertae_sedis) ~ stic_wet_prob*Rip_type, data=taxmerge_L)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)
taxmerge_L$Graminales<- as.factor(taxmerge_L$Graminales)
manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae, f__Helotiales_fam_Incertae_sedis) ~ stic_wet_prob*Graminales, data=taxmerge_L)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

Dothideo_wetdry <- ggplot(taxmerge_L, aes(x=WetDry, y=c__Dothideomycetes, fill=WetDry)) +
  #facet_grid(. ~ substrate, labeller = sub_labeller)+
  scale_x_discrete(labels=c('WET'='Wet', 'DRY'='Dry'))+
  geom_boxplot() +
  geom_boxplot_pattern(aes(pattern = WetDry), outlier.shape = NA, show.legend = FALSE) +
 ...
 # scale_fill_grey(start=0.9, end=0.35) +
  ylab("Relative Abundance (% ASV reads)")+
  geom_signif(comparisons = list(c("WET", "DRY")), y_position = 86,
              map_signif_level=TRUE)+
  labs(title = "Relative abundance of Dothidiomycetes in Leaf Litter")+
 # scale_fill_discrete(labels=c('B'='Epilithic biofilms', 'L'='Leaf litter', 'S'='Benthic sediment'))+
  #aes(fill=alpha$substrate, show.legend=FALSE)+
...
Leotio_wetdry <- ggplot(taxmerge_L, aes(x=WetDry, y=c__Leotiomycetes, fill=WetDry)) +
  #facet_grid(. ~ substrate, labeller = sub_labeller)+
  scale_x_discrete(labels=c('WET'='Wet', 'DRY'='Dry'))+
  geom_boxplot() +
  geom_boxplot_pattern(aes(pattern = WetDry), outlier.shape = NA, show.legend = FALSE) +
 ...
 # scale_fill_grey(start=0.9, end=0.35) +
  ...
  geom_signif(comparisons = list(c("WET", "DRY")), y_position = 86,
              map_signif_level=TRUE)+
  labs(title = "Relative abundance of Leotiomycetes in Leaf Litter")+
 # scale_fill_discrete(labels=c('B'='Epilithic biofilms', 'L'='Leaf litter', 'S'='Benthic sediment'))+
  #aes(fill=alpha$substrate, show.legend=FALSE)+
  theme(legend.position='none',axis.text.x = element_text(size=14), axis.title.x = element_blank(),strip.text.x = element_text(size = 11))
#  geom_boxplot(aes(fill=alpha$substrate)) +
...
gram_label<- c(`0`="Tree or shrub leaf litter only", `1`="Includes Graminaceous leaf litter")
alpha_TWI <- ggplot(taxmerge_L, aes(x=stic_wet_prob, y=f__Helotiaceae)) +
  facet_grid(. ~ Graminales, labeller = as_labeller(gram_label))+
  #geom_boxplot()+
 
  xlab(label='STIC Wet Probability')+
  geom_smooth(method = 'lm', se = FALSE, linetype="dashed", color="black")+
  ylab("Relative Abundance (% ASV reads)")+
  labs(title = "Relative abundance of Helotiaceae in Leaf Litter")+
   geom_point(aes(color=WetDry)) 
  #annotate("text", x = -0.25, y = 0.42, label = "cor.test", size=3.5)
alpha_TWI

taxLprair<- taxmerge_L[taxmerge_L$Rip_type=='Prairie',]
cor_heloprair<-cor.test(taxLprair$stic_wet_prob, taxLprair$f__Helotiaceae, method = "spearman")
cor_heloprair

taxLwood<- taxmerge_L[taxmerge_L$Rip_type=='Woody',]
cor_helowood<-cor.test(taxLwood$stic_wet_prob, taxLwood$f__Helotiaceae, method = "spearman")
cor_helowood

alpha_TWI <- ggplot(taxmerge_L, aes(x=stic_wet_prob, y=p__Basidiomycota)) +
 # facet_grid(. ~ Graminales)+
  ...
  geom_smooth(method = 'lm', se = FALSE, linetype="dashed", color="black")+
  ylab("Relative Abundance (% ASV reads)")+
  labs(title = "Relative abundance of Basidiomycota")
  #annotate("text", x = -0.25, y = 0.42, label = "cor.test", size=3.5)
alpha_TWI
...
#MANOVA
manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae) ~ WetDry, data=taxmerge_S)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,p__Blastocladiomycota,p__Kickxellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae) ~ stic_wet_prob*Rip_type, data=taxmerge_S)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,p__Blastocladiomycota,p__Kickxellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae) ~ Biofilm_Chl.a_.ug.cm2.*stic_wet_prob, data=taxmerge_S)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)
...
cor_Mort_wet<-cor.test(taxmerge_S$stic_wet_prob, taxmerge_S$p__Mortierellomycota, method = "spearman")
cor_Mort_wet
cor_Mort_alg<-cor.test(taxmerge_S$Biofilm_Chl.a_.ug.cm2., taxmerge_S$p__Mortierellomycota, method = "pearson")
cor_Mort_alg
#cor_areaB<-cor.test(alpha_B$Observed, alpha_B$TWI, method = "pearson")
#cor_areaB
#cor_areaS<-cor.test(alpha_S$Observed, alpha_S$TWI, method = "pearson")
...
rockmerge
```{r}
rock_merge <- taxmerge[taxmerge$substrate=='B',]
#MANOVA
manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae, f__Verrucariaceae) ~ WetDry, data=rock_merge)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae, f__Verrucariaceae) ~ stic_wet_prob*CanopyCoverPct, data=rock_merge)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)

manphy <- manova(cbind(p__Basidiomycota,p__Mortierellomycota,p__Rozellomycota,c__Dothideomycetes,c__Leotiomycetes,c__Sordariomycetes,c__Eurotiomycetes,c__Pezizomycetes,f__Phaeosphaeriaceae, f__Helotiaceae, f__Verrucariaceae) ~ stic_wet_prob*Biofilm_Chl.a_.ug.cm2., data=rock_merge)
hist(manphy$residuals)
plot(manphy$residuals ~ manphy$fitted.values)
summary.aov(manphy)
...
phyla_summary <- 
  ...
  group_by(Substrate, WetDry, Major_Taxa) %>%   # the grouping variable
...
phylum_bar <- ggplot(phyla_summary, aes(x = WetDry, y = mean_prop, fill = Major_Taxa))+
...
## [1] 4255.2 2364.0
plotout <- "Phylum Barplot_fulleuk_WetDry_v1_04072023.tiff"
...
```{r}
area_Phaeo <- ggplot(taxmerge, aes(x=lnContribWSha, y=f__Phaeosphaeriaceae, colour=substrate)) +
  facet_grid(. ~ substrate)+
  #geom_boxplot()+
  geom_point(aes(shape=WetDry)) +
  geom_smooth(method = 'lm')+
...
rock_merge<- taxmerge[taxmerge$substrate=='B',]
TWI_verruc <- ggplot(rock_merge, aes(x=TWI, y=f__Verrucariaceae, colour=substrate)) +
  #facet_grid(. ~ substrate)+
  #geom_boxplot()+
  geom_point(aes(shape=WetDry)) +
  geom_smooth(method = 'lm')+
...
TWI_wetdry <- ggplot(rock_merge, aes(x=stic_wet_prob, y=f__Verrucariaceae)) +
  #facet_grid(. ~ substrate)+
  #geom_boxplot()+
  geom_point(aes(shape=WetDry)) +
  geom_smooth(method = 'lm')+
...
rmw<- rock_merge[rock_merge$WetDry=='WET',] 
mean(rmw$f__Verrucariaceae)
rmd<- rock_merge[rock_merge$WetDry=='DRY',] 
mean(rmd$f__Verrucariaceae)
